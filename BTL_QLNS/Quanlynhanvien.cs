...
namespace BTL_QLNS
{
    public partial class Quanlynhanvien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                string date = $"{dtpNgaysinh.Value.Year}-{dtpNgaysinh.Value.Month}-{dtpNgaysinh.Value.Day}";
                MessageBox.Show(date);
                nvb.insertNV(txtMaNv.Text, txtTenNv.Text,date,
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.updateNV(txtMaNv.Text, txtTenNv.Text, dtpNgaysinh.Value.ToString("dd/MM/yyyy"),
                    txtDiachi.Text, luongnv, cbxPhongban.Text, cbxDuan.Text);
            Quanlynhanvien_Load(sender, e);
        }
        ...
        {
            ExportExcel(dgvNhanVien, @"C:\Users\nhan2\OneDrive\Desktop\NEW\new\new2\new3\quanlynhansu\BTL_QLNS\BTL_QLNS\Quanlynhasu_3FDataSet.xsd", "xuatfileExcel");
        }
    }
}
